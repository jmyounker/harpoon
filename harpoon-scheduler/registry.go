...
// dumpState generates a simplfiied snapshot of the registry state, intended
// to be used for debugging and introspection.
func (r *registry) dumpState() map[string]interface{} {
	r.RLock()
	defer r.RUnlock()
