...
func TestReceiveLogInstrumentation(t *testing.T) {
	...
	c := newFakeContainer("123", "", volumes{}, agent.ContainerConfig{}, false, nil, "harpoon-supervisor")
	registry.register(c)
...
func TestLogInstrumentationNotifyWithoutWatchers(t *testing.T) {
	...
	registry.register(newFakeContainer("123", "", volumes{}, agent.ContainerConfig{}, false, nil, "harpoon-supervisor"))

	// Create a second container which shouldn't receive any notifications
	// for the first channel.  This channel
	nonDestinationContainer := newFakeContainer("123", "", volumes{}, agent.ContainerConfig{}, false, nil, "harpoon-supervisor")
